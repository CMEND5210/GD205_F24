...
public class DarkResourceBar : MonoBehaviour
{
    ...
    //We use a float named CurrentDarkBar.
    ...
    void Update()
    {
        ...
        //Every frame, we update the CurrentDarkBar to be 50f + The inverse of the Wall X's position multiplied by 5.556f.
        UpdateBar();
        ...
        //We use the UpdateBar function to fill the bar.
    {
        ...
        //That is equal to the float of the CurrentDarkBar divided by the MaximumBarAmount.
